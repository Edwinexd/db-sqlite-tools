...
%TODO: IMAGE START POPUP
%TODO: Finns ett bättre sätt att göra detta på?
...
%TODO: image borde ha röd pil 
\subsection{Querying Data}
\label{sqliteStudioQueryingData}
% queries should be saved as Views
To create and run a query can be done by either pressing create view or open sql editor. We recommend create view as this will save your queries. After pressing create view you will be presented with a blank window where you can write your query and in the top you can enter your view name. After you have written your query you can press the green checkmark to save the view. To see the result you need to enter into data view. All saved views will be shown in the view list right below your tables.  
